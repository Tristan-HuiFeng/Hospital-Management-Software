...
<%--    <table style="width: 100%; text-align:center">
    ...
    <div class="form-group">
        <asp:Label ID="Label1" runat="server" Text="NRIC:  " hint="S*******X" ></asp:Label>
        <asp:TextBox ID="tb_nric" runat="server" class="form-control" aria-describedby="emailHelp" placeholder="Enter NRIC"></asp:TextBox>
        <small id="emailHelp" class="form-text text-muted">We'll never share your information with anyone else.</small>
    </div>

    <div class="form-group">
        <asp:Label ID="Label2" runat="server" Text="Date of birth:  " hint="DD/MM/YYYY"></asp:Label>
        <asp:TextBox ID="tb_dob" runat="server" class="form-control" placeholder="MM/DD/YYYY"></asp:TextBox>
    </div>

    <div class="form-check">
        <asp:CheckBox ID="chkPublic" runat="server" Text= "&nbsp;I agree to the terms and conditions of Lee's General Hospital." />
    </div>

        <asp:Button ID="btnSubmit" class="btnSubmit" runat="server" Text="Submit" onclick="btn_Submit"/>
        <asp:Button ID="btnCancel" class="btnCancel" runat="server" Text="Cancel" />
        <asp:Label ID="lblVerification" runat="server" Text="Please ensure all fields on this page are correct and / or agree to the terms and conditions!" Visible="false"></asp:Label>
